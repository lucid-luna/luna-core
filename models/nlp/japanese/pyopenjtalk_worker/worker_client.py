# ====================================================================
#  File: models/nlp/japanese/pyopenjtalk_worker/worker_client.py
# ====================================================================
import logging
import socket
...
class WorkerClient:
    ...
    def dispatch_pyopenjtalk(self, func: str, *args: Any, **kwargs: Any) -> Any:
        ...
        logger.trace(f"[L.U.N.A.] client sends request: {data}")
        send_data(self.sock, data)
        logger.trace("[L.U.N.A.] client sent request successfully")
        response = receive_data(self.sock)
        logger.trace(f"[L.U.N.A.] client received response: {response}")
