# ====================================================================
#  File: models/nlp/japanese/user_dict/part_of_speech_data.py
# ====================================================================
"""
...
from models.nlp.japanese.user_dict.word_model import (
...
part_of_speech_data: Dict[WordTypes, PartOfSpeechDetail] = {
    WordTypes.PROPER_NOUN: PartOfSpeechDetail(
        part_of_speech="명사",
        part_of_speech_detail_1="고유명사",
        part_of_speech_detail_2="일반",
