# ====================================================================
#  File: models/tts/models_jp_extra.py
# --------------------------------------------------------------------
#  TTS의 JP 모델을 정의하는 파일입니다.
#
...
from models.tts import attentions, commons, modules, monotonic_alignment
from models.nlp.symbols import NUM_LANGUAGES, NUM_TONES, SYMBOLS
