# ====================================================================
#  File: models/tts/attentions.py
# --------------------------------------------------------------------
#   JP 모델의 Attention 메커니즘을 정의하는 모듈입니다.
#
...
from models.tts import commons
...
class MultiHeadAttention(nn.Module):
    ...
    def attention(
        ...
        if self.window_size is not None:
            assert (
                t_s == t_t
            ), "[L.U.N.A.] Relative attention은 self-attention에만 사용할 수 있습니다."
        ...
        if self.proximal_bias:
            assert t_s == t_t, "[L.U.N.A.] Proximal bias는 self-attention에만 사용할 수 있습니다."
        ...
        if mask is not None:
            ...
            if self.block_length is not None:
                assert (
                    t_s == t_t
                ), "[L.U.N.A.] Local attention은 self-attention에만 사용할 수 있습니다."
                block_mask = (
